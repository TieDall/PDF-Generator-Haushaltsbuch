...
public class Launcher{
    ...
    public static void generatePiechart() throws IOException{
        ...
        BitmapEncoder.saveBitmap(chart, "./Piechart", BitmapFormat.PNG);
    ...
    public static void generateBarchart() throws IOException{
        ...
        BitmapEncoder.saveBitmap(chart, "./Barchart", BitmapFormat.PNG);
    ...
    public static void generateDonutchart() throws IOException{
        ...
        BitmapEncoder.saveBitmap(chart, "./Donutchart", BitmapFormat.PNG);
    ...
    public static void generateGgplot2chart() throws IOException{
        ...
        // Create Chart
        CategoryChart chart = new CategoryChartBuilder().width(800).height(300).title("Jahresübersicht").xAxisTitle("").yAxisTitle("").theme(ChartTheme.GGPlot2).build();
        ...
        BitmapEncoder.saveBitmap(chart, "./GGPlotchart", BitmapFormat.PNG);
    ...
    public static void generateBarchart2() throws IOException{
        ...
        BitmapEncoder.saveBitmap(chart, "./Barchart2", BitmapFormat.PNG);
